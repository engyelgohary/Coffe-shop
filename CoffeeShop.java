...
public class CoffeeShop {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(tcs.drinksOnly())); // ["Lemonade", "Orange juice", "Cranberry juice",
                                                               // "Pineapple juice"]

        // Test getting food only
        System.out.println(Arrays.toString(tcs.foodOnly())); // ["Cinnamon roll", "Ham and cheese sandwich", "Tuna
                                                             // sandwich"]
    }
}
